...
â”‚   â”œâ”€â”€ integration-and-messaging.md       sync/async conventions, external integration patterns
...
| `04-cross-cutting/security-and-compliance.md` | System-wide authN/authZ, data protection, and SAMA/PDPL compliance mapping. |
...
| `04-cross-cutting/integration-and-messaging.md` | Conventions for service-to-service and system-to-external-provider communication. |
| `04-cross-cutting/observability-and-operations.md` | How the system is watched and operated by a single developer. |
| `04-cross-cutting/reliability-and-performance.md` | System-wide availability/latency targets and the mechanisms used to hit them. |
...
| `05-deployment/environment-strategy.md` | The environment list (dev/staging/prod) and what differs between them. |
| `05-deployment/infrastructure-and-release.md` | Production topology, CI/CD, release/rollback, disaster recovery. |
