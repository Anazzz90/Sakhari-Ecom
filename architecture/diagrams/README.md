...
This document defines *where diagrams live and how they are named*. As of 2026-07-30, five structural diagrams (`generated-diagrams.md`), five business-flow diagrams (`generated-business-flow-diagrams.md`), five technical/cross-cutting diagrams (`generated-technical-diagrams.md`), and four documentation/governance diagrams (`generated-governance-diagrams.md`) exist — see each for its full set with purpose, explanation, and related-document annotations per diagram, and `source/` for the authoritative Mermaid source files.
...
## Status
`source/` contains nineteen diagrams across four sets:
...
- **Technical/cross-cutting** (event architecture, data ownership, deployment, security, observability): `event-architecture.mmd`, `data-ownership-diagram.mmd`, `deployment-diagram.mmd`, `security-architecture.mmd`, `observability-diagram.mmd`. Companion document: `generated-technical-diagrams.md`.
- **Documentation & governance** (decision traceability, ADR relationships, documentation hierarchy, executive architecture overview): `decision-traceability.mmd`, `adr-relationships.mmd`, `documentation-hierarchy.mmd`, `architecture-overview.mmd`. Companion document: `generated-governance-diagrams.md`. The `architecture-overview.mmd` diagram is the recommended first diagram at the top of `architecture/README.md`.

Each companion document provides Purpose, explanation, embedded Mermaid source, rendering notes, related ADRs, and related architecture documents per diagram; `generated-diagrams.md`, `generated-technical-diagrams.md`, and `generated-governance-diagrams.md` additionally carry a discrepancy report (Section 0) for any requested element that did not match what the approved documents actually establish. Each `.mmd` file's header comment names the document(s) it illustrates and the date last verified against them.
